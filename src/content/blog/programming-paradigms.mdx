...
# If your schema uses z.date(), use an ISO-like date literal (no quotes):
pubDate: 2025-11-25
...
_Using the same problem solved three different ways_
...
- Very explicit about _how_ the program flows
...
| ---------- | ---------------------------- | ----------------------------------------------- | --------------------------------------- |
| Procedural | "Do this, then this…"        | loops, mutation, explicit flow                  | scripts, simple transforms, performance |
